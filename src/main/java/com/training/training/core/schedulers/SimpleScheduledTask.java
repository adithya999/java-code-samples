package com.training.training.core.schedulers;
...
/**
 * A simple demo for cron-job like Schedular.
 * 
 */
...
public class SimpleScheduledTask implements Runnable {
    ...
    public void run() {
		...
		// Write any code here that you want to execute
		
	    logger.debug("SimpleScheduledTask is now complete");
    }
